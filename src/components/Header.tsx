...
export function Header() {
  ...
  // Mantivemos a MESMA lógica de classes que você mandou
  ...
  return (
    // Mantivemos as classes exatas do container: bg-gray-800, border-gray-700, py-4
    <header className="flex justify-between items-center px-8 py-4 bg-gray-800 border-b border-gray-700">
      ...
      <nav className="flex gap-4">
        ...
        {/* Removi o Dashboard daqui conforme solicitado */}
      ...
      {/* Área da direita: Entrar / Cadastro */}
